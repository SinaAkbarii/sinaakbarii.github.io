...
<span><strong>Tip:</strong> click a paper title to open its overview with results, figures, and key ideas. Use the chevron for a quick TL;DR, resources, and citation info.</span>
</div>
